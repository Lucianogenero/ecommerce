...
class DestroysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destroy" do
    assert_difference('Destroy.count') do
      post destroys_url, params: { destroy: { Clientes: @destroy.Clientes, cep: @destroy.cep, nome: @destroy.nome } }
    end
  ...
  test "should update destroy" do
    patch destroy_url(@destroy), params: { destroy: { Clientes: @destroy.Clientes, cep: @destroy.cep, nome: @destroy.nome } }
