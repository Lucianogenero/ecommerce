...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference('Estoque.count') do
      post estoques_url, params: { estoque: { preco: @estoque.preco, produto_id: @estoque.produto_id, saldo: @estoque.saldo } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { preco: @estoque.preco, produto_id: @estoque.produto_id, saldo: @estoque.saldo } }
